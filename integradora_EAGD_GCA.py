...
def insertar_datos(ip_privada, ip_publica, nombre_usuario):
    ...
    conexion = mysql.connector.connect(
        ...
        host='serverdb.ccawq1umegh3.us-east-1.rds.amazonaws.com',  # Cambia por la dirección de tu servidor MySQL

        database='prolog',  # Cambia por el nombre de tu base de datos
